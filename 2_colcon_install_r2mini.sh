...
echo "export ROS_DOMAIN_ID=777" >> ~/.bashrc
echo "export ROBOT_MODEL=r2mini" >> ~/.bashrc
echo "export LIDAR_MODEL=x4" >> ~/.bashrc
echo "export MOTOR_MODEL=old" >> ~/.bashrc
...
pip3 install -U argcomplete pyserial transforms3d
echo -e "\033[31m"extra ros package installation is done"\033[0m"

cd ~/ros2_ws/src
git clone https://github.com/t-shaped-person/r2mini.git
